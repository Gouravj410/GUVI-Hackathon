...
# Set API_KEY for testing (must match running server)
os.environ["API_KEY"] = "voicehack410"

# Use running server at localhost:8000 for tests
...
def test_detect_valid_audio_with_bearer_auth():
    ...
    response = client.post(
        ...
        headers={"Authorization": "Bearer voicehack410"}
    )
...
def test_detect_valid_audio_with_api_key_header():
    ...
    response = client.post(
        ...
        headers={"x-api-key": "voicehack410"}
    )
